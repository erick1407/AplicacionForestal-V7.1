...
public class ViewPDFNewtonActivity extends AppCompatActivity {
    private PDFView pdfView;
    private File file;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_view_pdfnewton);
        createDialog();
        pdfView = (PDFView) findViewById(R.id.pdfViewNewton);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try{
                    ...
                    Toast.makeText(ViewPDFNewtonActivity.this, "Exception: " + e.toString(), Toast.LENGTH_SHORT).show();
                }
            }
        }).start();
        progressDialog.show();
