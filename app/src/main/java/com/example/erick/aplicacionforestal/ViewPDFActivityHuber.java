...
public class ViewPDFActivityHuber extends AppCompatActivity {
    private PDFView pdfView;
    private File file;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_view_pdfhuber);
        createDialog();
        pdfView = (PDFView) findViewById(R.id.pdfViewHuber);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try{
                    ...
                    Toast.makeText(ViewPDFActivityHuber.this, "Exception: " + e.toString(), Toast.LENGTH_SHORT).show();
                }
            }
        }).start();
        progressDialog.show();
